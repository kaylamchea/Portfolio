      ...
      <div className="footer-content">
        ...
        <div data-aos="fade-up" data-aos-duration="1500" className="footer-socials">
          ...
          <div className="footer-icons">
            <a className="highlight underline me-2" href="https://www.linkedin.com/in/kaylamchea/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            <a className="highlight underline" href="https://github.com/kaylamchea" target="_blank" rel="noopener noreferrer">Github</a>
